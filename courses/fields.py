...
#if the field isn't existed yet in the object (as we could have saved the object before and resaving it for some reason like updating )
...
# class OrderField(PositiveIntegerField):
#     def __ini__(self, for_fields=None, *args, **kwargs):
#         self.for_fields = for_fields
